...
public class InstallerResources extends ListResourceBundle {
    ...
    public static final String JDK_NOT_SPECIFIED_MSG = "JDK_NOT_SPECIFIED_MSG"; 
    public static final String JDK_INVALID_MSG = "JDK_INVALID_MSG";        
    public static final String DEST_NOT_SPECIFIED_MSG = "DEST_NOT_SPECIFIED_MSG"; 
    public static final String DEST_INVALID_MSG = "DEST_INVALID_MSG";
    public static final String DEST_NO_WRITE_PERMISSION_MSG = "DEST_NO_WRITE_PERMISSION_MSG";
    public static final String DEST_COULD_NOT_CREATE_MSG = "DEST_COULD_NOT_CREATE_MSG";
    public static final String INST_DIR_ERRTITLE = "INST_DIR_ERRTITLE";       
    public static final String INST_DIR_ERRMSG = "INST_DIR_ERRMSG";  
    public static final String FCC_NOT_SPECIFIED_MSG = "FCC_NOT_SPECIFIED_MSG";    
    public static final String FCC_NOT_EXIST_MSG = "FCC_NOT_EXIST_MSG";        
    public static final String FCC_INVALID_MSG = "FCC_INVALID_MSG";     
    ...
    public static final String SER_NUM_NOT_SPECIFIED_MSG = "SERNUM_NOT_SPECIFIED_MSG";
    public static final String SER_NUM_INVALID_MSG = "SERNUM_INVALID_MSG";      
    ...
    static final Object contents[][] = {
        ...
        {"ASSOCIATION_QUESTION", "Do You want to associate .java and .nbm (NetBeans Module) files with this IDE ?"},
        {"ASSOCIATION_JAVA_RESPONSE", "Yes I want to associate .java files with this IDE"},
        {"ASSOCIATION_NBM_RESPONSE", "Yes I want to associate .nbm files with this IDE"},
        ...
        {"JVM_FOUND_DESCRIPTION", "Installer found the following JDK(tm) to use with Forte(tm) for Java(tm) 4.0. J2SE(tm) 1.4.0 is the recommended JDK. We strongly recommend that you specify it here."},
        {"JVM_NOT_FOUND_DESCRIPTION", "Installer could not find a suitable JDK(tm) to use with Forte(tm) for Java(tm) 4.0. J2SE(tm) 1.4.0 is the recommended JDK. We strongly recommend that you specify it here."},
        ...
        {"FCC_PATH_NOT_SPECIFIED_MSG", "Even though you have chosen to install the Solaris Developer Modules, you did not provide the path to your Forte(tm) Compiler Collection (FCC) software. You can specify the FCC path to use with the Solaris Developer tools at a later time. Refer to the Getting Started Guide for more details."}, 
        ...
        {"POINTED_REQUIRED_MSG","Warning: J2EE Reference Implementation requires Pointbase. So Pointbase will be installed"},        
        {"JDK_NOT_SPECIFIED_MSG","No JDK Home Specified. Specify using -DjdkHome."},
        {"JDK_INVALID_MSG","Specified JDK Home is invalid"},   
        {"SER_NUM_NOT_SPECIFIED_MSG","No Serial Number Specified. Specify using -DserialNumber. -DserialNumber=trial to create trial Serial Number"},
        {"SER_NUM_INVALID_MSG","Specified Serial Number is invalid"},         
        {"DEST_NOT_SPECIFIED_MSG","No Install Directory Specified. Specify using -DforteHome."},
        {"DEST_INVALID_MSG","Specified Install Directory is invalid"}, 
        {"DEST_NO_WRITE_PERMISSION_MSG","Specified Install Directory has no write permission !"},
        {"DEST_COULD_NOT_CREATE_MSG","Could not create the Install Directory !"},         
        {"INST_DIR_ERRTITLE","Install Directory"},
        {"INST_DIR_ERRMSG","Install Directory doesnot exist. Create?"},
        {"FCC_NOT_SPECIFIED_MSG","No FCC Home Specified. Specify using -DfccHome."},
        {"FCC_NOT_EXIST_MSG","Specified FCC Home doesnot exist!"},
        {"FCC_INVALID_MSG","Specified FCC Directory is invalid"},      
